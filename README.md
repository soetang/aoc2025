...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `131.3µs` | `132.9µs` |
| [Day 2](./src/bin/02.rs) | `60.1ms` | `74.3ms` |
| [Day 3](./src/bin/03.rs) | `78.4µs` | `176.3µs` |
| [Day 4](./src/bin/04.rs) | `181.3µs` | `560.5µs` |
| [Day 5](./src/bin/05.rs) | `57.6µs` | `47.5µs` |
| [Day 6](./src/bin/06.rs) | `380.0µs` | `478.3µs` |
| [Day 7](./src/bin/07.rs) | `206.5µs` | `65.5µs` |
| [Day 8](./src/bin/08.rs) | `5.5ms` | `5.6ms` |
